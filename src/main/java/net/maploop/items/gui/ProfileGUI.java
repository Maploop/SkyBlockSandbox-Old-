...
public class ProfileGUI extends GUI {
    ...
    public void setItems() {
        ...
        setFilter();
        inventory.setItem(49, makeItem(Material.BARRIER, IUtil.colorize("&cClose"), 1, 0));
        inventory.setItem(48, makeItem(Material.ARROW, IUtil.colorize("&aGo Back"), 1, 0, ChatColor.GRAY + "To Skyblock GUI"));
