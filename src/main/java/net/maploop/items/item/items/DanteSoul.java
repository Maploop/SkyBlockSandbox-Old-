...
public class DanteSoul extends CustomItem {
    public DanteSoul() {
        super(11112, Rarity.LEGENDARY, "Dante's Soul", Material.MAGMA_CREAM, 0, false, false, false,null, 0, false, ItemType.SUMMONING, true);
    }
    ...
    public void getSpecificLorePrefix(List<String> lore, ItemStack paramItemStack) {
        lore.add("§7Trade this in with §cDante");
        lore.add("§7in the §bColosseum");
        lore.add("§7to summon the Slime God.");
    }
    ...
    public void rightClickAirAction(Player player, PlayerInteractEvent event, ItemStack item) {
        player.sendMessage(IUtil.colorize("&aUse this item at dante to spawn dante!"));
    }
