...
public class JumboBackpack extends CustomItem {

    public JumboBackpack(int id, Rarity rarity, String name, Material material, int durability, boolean stackable, boolean oneTimeUse, boolean hasActive, List<ItemAbility> abilities, int manaCost, boolean reforgeable, ItemType itemType, String url, boolean glowing) {
    ...
    public void rightClickAirAction(Player player, PlayerInteractEvent event, ItemStack item) {
        ...
        Inventory backPackinv = Bukkit.createInventory(player, 9 * 6, "Jumbo Backpack");
