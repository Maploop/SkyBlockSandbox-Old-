...
public class RADIANT_POWER_ORB {
    ...
    public static void load() {
        item = Item.makeCustomSkullItem("http://textures.minecraft.net/texture/7ab4c4d6ee69bc24bba2b8faf67b9f704a06b01aa93f3efa6aef7a9696c4feef", "§aRadiant Power Orb", 1,
