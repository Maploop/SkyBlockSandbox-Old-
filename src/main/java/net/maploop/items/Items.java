...
public final class Items extends JavaPlugin {
    ...
    private void registerItems() {
        ...
        SBItems.putItem("aspect_of_the_jerry", new AspectOfTheJerry(27, Rarity.COMMON, "Aspect of the Jerry", Material.WOOD_SWORD, 0, true, false, false, Collections.singletonList(new ItemAbility("Parley", AbilityType.RIGHT_CLICK, IUtil.colorize("&7Channel your inner parley."), 5)), 0, true, ItemType.SWORD, false, 1, 0, 0, 0, 0));
